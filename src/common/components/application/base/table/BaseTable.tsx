  ...
  return (
    <div>
      <div className="flex items-center space-x-5 mb-6">
        ...
        <Dropdown className="inline-flex space-x-5 shadow-sm items-center text-tx-dark bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-md text-sm px-3 py-2 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <Dropdown
          className={`inline-flex space-x-5 shadow-sm items-center text-tx-dark bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-md text-sm px-3 py-2 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700`}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="mr-2 w-5 h-5"
          ...
          <span className="sr-only">filter-by button</span>
          Filter By
          <svg
            className="ml-2 w-3 h-3"
            aria-hidden="true"
