...
const StepOne: FC<IProps> = ({ next, back, step }: IProps) => {
  const { mutate } = contractRegQueries.update();
  ...
  // const [earlyID, setEarlyID] = useState<string>();
  ...
  const notifications =
    earlyByMda?.data?.data?.notifications === undefined
      ? []
      : earlyByMda?.data?.data?.notifications;
  ...
  const defaultPayload = {
    id: contractID,
    status: "",
    mda: contractData?.mda ?? contractRegData?.mda ?? "",
    users_id: userId,
    early_notifications_id: contractData?.early_notifications_id ?? event ?? "",
    title: contractData?.title ?? contractRegData?.title ?? "",
    bpp: contractData?.bpp ?? contractRegData?.bpp ?? "",
    typology: contractData?.typology ?? contractRegData?.typology ?? "",
    contractor_type:
      contractData?.contractor_type ?? contractRegData?.contractor_type ?? "",
    amount_mtb: contractData?.amount_mtb ?? contractRegData?.amount_mtb ?? "",
    vat: contractData?.vat ?? contractRegData?.vat ?? "",
    withholding_tax:
      contractData?.withholding_tax ?? contractRegData?.withholding_tax ?? "",
    advance_payment:
      contractData?.advance_payment ?? contractRegData?.advance_payment ?? "",
    scope: contractData?.scope ?? contractRegData?.scope ?? "",
    duration: contractData?.duration ?? contractRegData?.duration ?? "",
    location: contractData?.location ?? contractRegData?.location ?? "",
    mdax1_name: contractData?.mdax1_name ?? contractRegData?.mdax1_name ?? "",
    mdax1_phone:
      contractData?.mdax1_phone ?? contractRegData?.mdax1_phone ?? "",
    mdax1_email:
      contractData?.mdax1_email ?? contractRegData?.mdax1_email ?? "",
    mdax1_position:
      contractData?.mdax1_position ?? contractRegData?.mdax1_position ?? "",
    mdax1_department:
      contractData?.mdax1_department ?? contractRegData?.mdax1_department ?? "",
    mdax2_name: contractData?.mdax2_name ?? contractRegData?.mdax2_name ?? "",
    mdax2_phone:
      contractData?.mdax2_phone ?? contractRegData?.mdax2_phone ?? "",
    mdax2_email:
      contractData?.mdax2_email ?? contractRegData?.mdax2_email ?? "",
    mdax2_position:
      contractData?.mdax2_position ?? contractRegData?.mdax2_position ?? "",
    mdax2_department:
      contractData?.mdax2_department ?? contractRegData?.mdax2_department ?? "",
    mda_lfp_name:
      contractData?.mda_lfp_name ?? contractRegData?.mda_lfp_name ?? "",
    mda_lfp_phone:
      contractData?.mda_lfp_phone ?? contractRegData?.mda_lfp_phone ?? "",
    mda_lfp_email:
      contractData?.mda_lfp_email ?? contractRegData?.mda_lfp_email ?? "",
    mda_lfp_position:
      contractData?.mda_lfp_position ?? contractRegData?.mda_lfp_position ?? "",
    mda_lfp_department:
      contractData?.mda_lfp_department ??
      contractRegData?.mda_lfp_department ??
      "",
    ct_type: contractData?.ct_type ?? contractRegData?.ct_type ?? "",
    ct_name: contractData?.ct_name ?? contractRegData?.ct_name ?? "",
    ct_cac_reg_number:
      contractData?.ct_cac_reg_number ??
      contractRegData?.ct_cac_reg_number ??
      "",
    ct_web: contractData?.ct_web ?? contractRegData?.ct_web ?? "",
    ct_office_address:
      contractData?.ct_office_address ??
      contractRegData?.ct_office_address ??
      "",
    ct_phone: contractData?.ct_phone ?? contractRegData?.ct_phone ?? "",
    ct_email: contractData?.ct_email ?? contractRegData?.ct_email ?? "",
    ct_taxid: contractData?.ct_taxid ?? contractRegData?.ct_taxid ?? "",
    ct_project_office:
      contractData?.ct_project_office ??
      contractRegData?.ct_project_office ??
      "",
    ct_rep_name:
      contractData?.ct_rep_name ?? contractRegData?.ct_rep_name ?? "",
    ct_rep_address:
      contractData?.ct_rep_address ?? contractRegData?.ct_rep_address ?? "",
    ct_rep_phone:
      contractData?.ct_rep_phone ?? contractRegData?.ct_rep_phone ?? "",
    ct_rep_email:
      contractData?.ct_rep_email ?? contractRegData?.ct_rep_email ?? "",
    ct_rep_nin: contractData?.ct_rep_nin ?? contractRegData?.ct_rep_nin ?? "",
    ct_rep1_name:
      contractData?.ct_rep1_name ?? contractRegData?.ct_rep1_name ?? "",
    ct_rep1_address:
      contractData?.ct_rep1_address ?? contractRegData?.ct_rep1_address ?? "",
    ct_rep1_phone:
      contractData?.ct_rep1_phone ?? contractRegData?.ct_rep1_phone ?? "",
    ct_rep1_email:
      contractData?.ct_rep1_email ?? contractRegData?.ct_rep1_email ?? "",
    ct_rep1_nin:
      contractData?.ct_rep1_nin ?? contractRegData?.ct_rep1_nin ?? "",
    ct_rep1_position:
      contractData?.ct_rep1_position ?? contractRegData?.ct_rep1_position ?? "",
    ct_rep2_name:
      contractData?.ct_rep2_name ?? contractRegData?.ct_rep2_name ?? "",
    ct_rep2_address:
      contractData?.ct_rep2_address ?? contractRegData?.ct_rep2_address ?? "",
    ct_rep2_phone:
      contractData?.ct_rep2_phone ?? contractRegData?.ct_rep2_phone ?? "",
    ct_rep2_email:
      contractData?.ct_rep2_email ?? contractRegData?.ct_rep2_email ?? "",
    ct_rep2_nin:
      contractData?.ct_rep2_nin ?? contractRegData?.ct_rep2_nin ?? "",
    ct_rep2_position:
      contractData?.ct_rep2_position ?? contractRegData?.ct_rep2_position ?? "",
    bpp_no_objection: attach1?.file_url ?? contractData?.bpp_no_objection ?? "",
    letter_of_award: attach2?.file_url ?? contractData?.letter_of_award ?? "",
    draft_contract_upload:
      attach3?.file_url ?? contractData?.draft_contract_upload ?? "",
    draft_pacap_upload:
      attach4?.file_url ?? contractData?.draft_pacap_upload ?? "",
    draft_rmp_upload: attach5?.file_url ?? contractData?.draft_rmp_upload ?? "",
    cac_reg_upload: attach6?.file_url ?? contractData?.cac_reg_upload ?? "",
    ni_rep_upload: attach7?.file_url ?? contractData?.ni_rep_upload ?? "",
    ni_rep1_upload: attach8?.file_url ?? contractData?.ni_rep1_upload ?? "",
    nitda: attach9?.file_url ?? contractData?.nitda,
    letter_of_acceptance:
      attach10?.file_url ?? contractData?.letter_of_acceptance ?? "",
    icrc: attach11?.file_url ?? contractData?.icrc ?? "",
    fec_extract: attach12?.file_url ?? contractData?.fec_extract,
    other_uploads: attach13?.file_url ?? contractData?.other_uploads ?? "",
  };
                  ...
                  <>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-6 mt-12">
                      ...
                      {/* <BaseFormInput
                        ...
                        name="ct_rep_nin"
                        label="NIN"
                        value={values.ct_rep_nin}
                        onChange={(e: any) => {
                           
handleChange(e);
                          pushData(e);
                        }}
                        error={errorParser(errors, touched, "ct_rep_nin")}
                      /> */}
                    </div>
                  </>
                )}
                  ...
                  <>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-6 mt-12">
                      ...
                      <BaseFormInput
                        ...
                        error={errorParser(errors, touched, "letter_of_award")}
                      />
